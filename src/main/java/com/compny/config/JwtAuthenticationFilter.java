...
import com.compny.config.details.CustomProfileDetails;
import com.compny.config.details.CustomProfileDetailsService;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            Role role = decode.getRole();

            CustomProfileDetails details = (role.equals(Role.ROLE_SUPER_ADMIN))
                    ?
                        customProfileDetailsService.loadUserByUsername(id)
                    :
                        customProfileDetailsService.loadUserByUsernameFromAdmin(id);
